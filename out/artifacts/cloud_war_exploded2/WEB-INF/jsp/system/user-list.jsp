    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
		...
		<!--**********************************
            Content body start
        ***********************************-->
		<form action="${basePath}/his/search" id="mainForm" method="post">
						...
						<div class="table-responsive">
							...
							<table id="example5"  class="table table-striped patient-list mb-4 dataTablesCard fs-14">
								...
								<tr>
									...
									<td>${list.realName}</td>
									<td>${list.useType}</td>
									<td>${list.docTitleID}</td>
									<td>${list.isScheduling}</td>
									<td>${list.deptID}</td>
									<td>${list.registLeID}</td>
									<td>${list.delMark}</td>
									<td>
										<a href="#" >
										...
										<a href="#" onclick="location.href = '${basePath}/ad/delete/${list.id};'">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
