                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" id="mainForm" name="mainForm" action="${basePath}/his/insert" method="post">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="UseType" name="UseType" placeholder=">UseType">
                                                    </div>
												</div> 
												<div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="DocTitleID" name="DocTitleID" placeholder="DocTitleID">
                                                    </div>
												</div>												
												<div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="IsScheduling" name="IsScheduling" placeholder="IsScheduling">
                                                    </div>
												</div>
												<div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" id="DelMark" name="DelMark" placeholder="DelMark">
                                                    </div>
                                                </div>
												<div class="form-group row">
